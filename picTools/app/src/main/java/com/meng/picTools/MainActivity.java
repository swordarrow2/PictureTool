...
public class MainActivity extends Activity{
    ...
    private final String tmpFolder=exDir+"/Pictures/picTool/tmp/";
    private final String awesomeQRPath=exDir+"/Pictures/picTool/AwesomeQR/";
    private final String arbAwesomeQRPath=exDir+"/Pictures/picTool/arbAwesomeQR/";
    private final String gifArbAwesomeQRPath=exDir+"/Pictures/picTool/gifArbAwesomeQR/";
    private final String gifAwesomeQRPath=exDir+"/Pictures/picTool/gifAwesomeQR/";
    private final String gifPath=exDir+"/Pictures/picTool/gif/";
    private final String barcodePath=exDir+"/Pictures/QRcode/";
	private final String pixivZipPath=exDir+"/Pictures/pixivZip/";
	...
	public String getPixivGifPath(String zipName){
